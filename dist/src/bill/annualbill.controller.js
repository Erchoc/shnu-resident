...
let AnnualBillController = class AnnualBillController extends crud_controller_1.CrudController {
    ...
    generate(range, resident) {
        return __awaiter(this, void 0, void 0, function* () {
            let [from, to] = range.range;
            if (!from || !to)
                return [];
            let res = yield this.service.generate(from, to, resident);
            return res;
        });
    }
    generateSheetByResident(range, resident, resp) {
        return __awaiter(this, void 0, void 0, function* () {
            let [from, to] = range.range;
            let res = yield this.service.generateSheetByResident(from, to, resident);
...
__decorate([
    common_1.Post('/query'),
    __param(0, common_1.Body()), __param(1, common_1.Param('resident')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], AnnualBillController.prototype, "generate", null);
__decorate([
    common_1.Post('/resident/:resident/sheet'),
    __param(0, common_1.Body()), __param(1, common_1.Param('resident')), __param(2, common_1.Res()),
    __metadata("design:type", Function),
