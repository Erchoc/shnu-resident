...
let ResidentService = class ResidentService extends crud_typeorm_service_1.CrudTypeOrmService {
    constructor(repo) {
        super(repo);
        this.repo = repo;
    }
...
ResidentService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(resident_entity_1.Resident)),
