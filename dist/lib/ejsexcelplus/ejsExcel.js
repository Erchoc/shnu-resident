function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try {
    ...
    return Promise.resolve(value).then(function (value) { return step("next", value); }, function (err) { return step("throw", err); });
} } return step("next"); }); }; }
(function () {
        ...
        var _ref2 = _asyncToGenerator(function* (exlBuf, _data_) {
            ...
            data._ps_ = function (str, buf) {
                ...
                if (val.indexOf('**RED**') >= 0) {
                    val = val.replace("**RED**", "");
                    sharedStrings2.push(Buffer.from("<si><r><rPr><color rgb=\"FF0000\"/></rPr><t xml:space=\"preserve\">" + val + "</t></r></si>"));
                }
                else {
                    sharedStrings2.push(Buffer.from("<si><t xml:space=\"preserve\">" + val + "</t></si>"));
                }
...
//# sourceMappingURL=ejsExcel.js.map